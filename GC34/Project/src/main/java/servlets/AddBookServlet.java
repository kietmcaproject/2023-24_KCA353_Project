...
public class AddBookServlet extends HttpServlet {
    ...
    private static void showAddBookForm(PrintWriter pw) {
        String form = "<table class=\"tab my-5\" style=\"width:40%;\">\r\n"
                ...
                + "                    <label for=\"bookName\">Book Name : </label> <input type=\"text\" name=\"name\" id=\"bookName\" placeholder=\"Enter Book's name\" pattern=\"[a-zA-Z+-#.]\"  required><br/>\r\n"
                ...
                + "                    <label for=\"bookPrice\">Book Price : </label><input type=\"text\" name=\"price\" placeholder=\"Enter the Price\" pattern=\"[0-9]{1,4}\" required><br/>\r\n"
                + "                    <label for=\"bookQuantity\">Book Qnty : </label><input type=\"text\" name=\"quantity\" id=\"bookQuantity\" placeholder=\"Enter the quantity\" pattern=\"[0-9]{1,4}\" required><br/>\r\n"

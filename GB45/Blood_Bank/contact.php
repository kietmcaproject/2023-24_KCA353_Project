...
?>
    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Blood Bank &amp; <br>KIET, <br>
					Muradnagar,<br>
					U.P.-201206.<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P-no</abbr>: +91-9135379585 , +91-8171512919</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E-mail</abbr>: <a href="#" >yashwant.2224mca1179@kiet.edu, vishal.2224mca1185@kiet.edu</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: 24*7</p>
				<p><i class="fa fa-globe"></i> 
                    <abbr title="Website">Website</abbr>: <a href="https://www.kiet.edu/">https://www.kiet.edu/</a></p>

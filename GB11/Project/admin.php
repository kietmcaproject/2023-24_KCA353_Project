  ...
  <section id="main-slider" class="no-margin">
    <div class="carousel slide">
      <div class="carousel-inner">
        ...
        <h3 style="font-family:Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif; color:#6d6875; text-align:center; padding:30vh; font-size:6vw"> WelCome,<span class="animation animated-item-3" style="color:#e85d04;border:3px solid #582c4d ;padding:2px"><?php echo $message ?></span></h3>
          <div class="container">

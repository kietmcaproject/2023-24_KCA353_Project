...
const NavBar = ({ setProgress }) => {
    ...
    return (
        <div className={` flex sm:relative bg-richblack-900 w-screen relative z-50 h-18 items-center justify-center border-b-[1px] border-b-richblack-700 translate-y-  transition-all duration-500`}>

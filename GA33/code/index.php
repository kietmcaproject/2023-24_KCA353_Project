    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php">Learn A Bit</a></div>
          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="sign">
                <!--sign-->
                <div
                  class="container <?php echo (isset($_GET['errorp']) || isset($_GET['signup'])) ? 'right-panel-active' : ''; ?>"
                  id="container">
    ...
    <div class="container">
      <div class="row mb-5 justify-content-center">
        <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
          ...
          <p>We aim to make studying SIMPLE, EASY and ACCESSIBLE to EVERYONE thus we collected the BEST COURSES in the
    ...
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="col-md-8 text-center testimony">
          ...
          <blockquote>
            <p>&ldquo; I was struggling with my studies but it all changed when I learned about Learn A Bit, I'm now a
              senior software engineer making a 6 figure salary per year.This website is a real game changer. &rdquo;
            </p>
          </blockquote>
        </div>
      </div>
          ...
          if (filter_has_var(INPUT_POST, 'submit')) {
            ...
            if (!empty($email) && !empty($name) && !empty($message) && !empty($subject)) {
              ...
              if (filter_var($email, FILTER_VALIDATE_EMAIL) === false) {
                ...
                // Passed
                $toEmail = 'support@Learn A Bit.com';
  ...
  <footer class="footer-section bg-white">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <h3>Subscribe</h3>
          <p>Keep yourself up to date and receive all kind of news about LearnABit.</p>

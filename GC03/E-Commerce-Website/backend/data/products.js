const products = [
  {
    ...
    description:
      'Super soft and cozy - Crafted from an ultra-soft fleece fabric, our Alterra jacket offers maximum warmth and protection from the cold.
      Zipper closure - Our Alterra jacket comes designed with a front full zipper closure for practical use and pop color piping at the neck and sleeves for a design element.
      Pockets - It comes with a wrinkle nylon tonal patch pocket along with two side seam pockets in the front to warm hands.
      Suitable for harsh winters - When the temperature drops to an all-time low, this fleece jacket is designed to keep you warm and super-comfy through it all.
      Layering essentials - Supremely soft with colourful accents, our Alterra fleece jacket is made to keep you warm and comfy when the temperature drops.',
    category: ['Men','Jacket'],
    sizes: ['S','XS'],
    price: 150.99,
    countInStock: 10,
